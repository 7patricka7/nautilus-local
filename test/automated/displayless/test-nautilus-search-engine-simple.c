      ...
      char *argv[])
{
    ...
    test_nautilus_search_by_mtime (engine, NAUTILUS_SEARCH_ENGINE_SIMPLE_ENGINE, "engine_simple");
    ...
    test_nautilus_search_by_atime (engine, NAUTILUS_SEARCH_ENGINE_SIMPLE_ENGINE, "engine_simple");
