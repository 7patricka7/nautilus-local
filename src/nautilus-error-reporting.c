                                     ...
                                     GtkWindow    *parent_window)
{
    ...
    show_dialog (_("The group could not be changed."), message, parent_window);
}
                                     ...
                                     GtkWindow    *parent_window)
{
    ...
    show_dialog (_("The owner could not be changed."), message, parent_window);
}
                                     ...
                                     GtkWindow    *parent_window)
{
    ...
    show_dialog (_("The item could not be renamed."), message, parent_window);
}
