/* nautilus-new-item-dialog-controller.h
 *
...
#define NAUTILUS_TYPE_NEW_ITEM_DIALOG_CONTROLLER nautilus_new_item_dialog_controller_get_type ()
G_DECLARE_FINAL_TYPE (NautilusNewItemDialogController, nautilus_new_item_dialog_controller, NAUTILUS, NEW_ITEM_DIALOG_CONTROLLER, NautilusFileNameWidgetController)
